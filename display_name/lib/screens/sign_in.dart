...
import 'package:display_name/blocs/signInBloc/sign_in_bloc_state.dart';
import 'package:display_name/data/enum/signinEnum.dart';
  ...
  Widget build(BuildContext context) {
    return BlocListener<SignInBloc, SignInBlocState>(
      listener: (context, state) {
        if (state.signinStatus == SigninStatus.authenticated) {
          print("here");
          BlocProvider.of<AuthenticationBlocBloc>(context)
              .add(GetCurrentUserEvent());
          CustomNavigation.toHome();
        } else if (state.signinStatus == SigninStatus.unauthenticated) {
